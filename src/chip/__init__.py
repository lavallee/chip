...
_LAZY: dict[str, tuple[str, str]] = {
    ...
    # taint
    "DEFAULT_INSTRUCTION_KEYS": ("chip.tainting", "DEFAULT_INSTRUCTION_KEYS"),
    "taint": ("chip.tainting", "taint"),
    "taint_gateway_result": ("chip.tainting", "taint_gateway_result"),
    "is_tainted": ("chip.tainting", "is_tainted"),
    "propagate": ("chip.tainting", "propagate"),
    "quote_span": ("chip.tainting", "quote_span"),
    "assert_untainted_for_instructions": ("chip.tainting", "assert_untainted_for_instructions"),
    "remove_taint": ("chip.tainting", "remove_taint"),
    # state
